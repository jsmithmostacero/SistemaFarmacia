...
INSERT INTO producto (cantidad, precio, id_producto, id_proveedor, id_tipo_producto, descripcion, nombre, producto_imagen_id,producto_imagen_url)
VALUES (45, 4.00, 1, 1, 2, 'Esta es una pastilla que da efecto a las 12 hrs.', 'Apronax', 'wc0pvufgjahyjyqffjyv','http://res.cloudinary.com/dxcsnwzxa/image/upload/v1707257135/wc0pvufgjahyjyqffjyv.jpg');
