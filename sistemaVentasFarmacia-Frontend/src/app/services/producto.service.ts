...
updateNotImage(idProducto: number, producto: Producto): Observable<Producto> {
  
  console.info("==================================================");
  console.info(producto);
  console.info("==================================================");
  const url = `${baseUrl}producto/updateNotImage?idProducto=${idProducto}`;
  return this.httpClient.post<Producto>(url, producto);
}
